...
function Assigned() {
  ...
  return (
    ...
    <Grid container spacing={2}>
        ...
        <Grid item lg={8}>
            <Box sx={{border:'1px solid black',position:'relative',borderRadius:'16px',height:'700px',backgroundColor:'#ffffff54',padding:'10px'}}>
                <div className='font-display text-2xl font-bold'>Assigned to me</div>
